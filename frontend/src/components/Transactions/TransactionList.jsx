...
const TransactionList = () => {
  ...
  return (
    <div className="my-4 p-4 shadow-lg rounded-lg bg-white  border-2 border-purple-700">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6  border-solid border-lime-500">
        {/* Start Date
        <input
          type="date"
          name="startDate"
        ...
        /> */}
        {/* Type */}
        <div className="relative border-2 rounded border-gray-400">
          <select
            name="type"
            value={filters.type}
            onChange={handleFilterChange}
