...
import { SiAuthy,SiCentos } from "react-icons/si";
            ...
            <div className="flex h-16 justify-start items-center">
              <div className="flex justify-center flex-row w-full">
                ...
                <div className="flex flex-shrink-0 items-center">
                  {/* Logo */}
                  <SiCentos className="h-8 w-auto text-emerald-500" />
                </div>
                ...
                <div className="hidden md:ml-6 md:flex md:space-x-8">
                  <Link
                    to="/add-transaction"
                    className="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-blue-700 "
                  >
                    Add Transaction
                  </Link>
                  <Link
          ...
          <Disclosure.Panel className="md:hidden">
            <div className="space-y-1 pb-3 pt-2">
              <Link to="/">
                <Disclosure.Button
                  as="button"
                  className="block border-l-4 border-transparent py-2 pl-3 pr-4 text-base font-medium text-gray-500 hover:border-gray-300 hover:bg-gray-50 hover:text-blue-700  sm:pl-5 sm:pr-6"
                >
                  TRACK
                </Disclosure.Button>
              </Link>
